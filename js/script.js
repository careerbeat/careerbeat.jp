...
$(document).ready(function() {
    ...
    $(".home-text1 span:eq(0)").delay(2000).animate({ opacity: 1 }, 2000, function() { 
        $(".home-text1 span:eq(1)").delay(400).animate({ opacity: 1 }, 2000, function() { 
            $(".home-text1 span").delay(1000).animate({ opacity: 0 }, 1400, function() {
                $(".home-text2 span").delay(400).animate({ opacity: 1 }, 1000, function() { 
                    $(".home-text2 span").delay(1000).animate({ opacity: 0 }, 1000, function() {
                        $(".logo img").delay(300).animate({ opacity: 1 }, 1000, function() {
    ...
    function scrollButtonActivate() {
       $(".scroll-button").animate({opacity:'1'}, 1000);
       $(".scroll-button").animate({opacity:'0.3'}, 1000, scrollButtonActivate);
    }
    ...
    setInterval(function() {
        ...
        var text1Pad = containerHeight - $(".home-text1").height();
        var text2Pad = containerHeight - $(".home-text2").height();
        $(".home-text1").css({
            'padding-top': Math.round(text1Pad / 2) + 'px',
            'padding-bottom': Math.round(text1Pad / 2) + 'px'
        });
        $(".home-text2").css({
            'padding-top': Math.round(text2Pad / 2) + 'px',
            'padding-bottom': Math.round(text2Pad / 2) + 'px'
        });
    }, 10)
});
